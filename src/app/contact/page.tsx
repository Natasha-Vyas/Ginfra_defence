        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-secondary-200 mb-8">
              Ready to discuss your manufacturing requirements? Our technical
              team is here to support your mission-critical applications with
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-secondary-600 max-w-3xl mx-auto">
              Our team is ready to support your specific requirements across
