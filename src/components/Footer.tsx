...
const Footer = () => {
  return (
    <footer className="relative text-white bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 overflow-hidden">
      {/* Background pattern and shapes to match home banner */}
